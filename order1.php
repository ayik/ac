...
<div class="container">
      ...
      <br><br><br>
          ...
          <br><br>
            <form role="form" action="view/input_order1.php" method="post">
      <div class="form-group">
      <label for="text">Sparepart yang dibutuhkan :</label>
      <select class="form-control" name="sparepart">
        <?php $result = mysqli_query($con,"SELECT * FROM barang");
        while ($r=mysqli_fetch_array($result)) {?>
          <option value=<?php echo $r['jenis sparepart'] ?>><?php echo $r['jenissparepart'] ?></option>
          <?php } ?>
      </select>
      ...
      <hr class="batas">
      <label for="text">Jumlah Sparepart</label>
